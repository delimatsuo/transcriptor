...
| `docs/plans/2026-07-15-phase-1-native-capture-spike.md` | Phase plan | 1A offline authorized; guard awaiting review; 1B-1D blocked | Do not begin conformance until guard review passes |
