 ...
 *
 * T.A.R.S. runs two independent capture streams — the browser microphone
 * (Entrevistador) and the native companion's system audio (Candidato) — so
 * interim results from both speakers are in flight simultaneously during
